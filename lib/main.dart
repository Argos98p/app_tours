  ...
  Widget build(BuildContext context) {
    return MultiProvider(
        providers: [
          ...
          ChangeNotifierProvider<PisosProviders>(
              create: (_) => PisosProviders()),
          ChangeNotifierProvider<ImagesInReelProvider>(
              create: (_) => ImagesInReelProvider()),
        ],
        builder: (context, _) {
          return MaterialApp(
            title: 'Flutter Demo',
            ...
            home: /*Home()*/ const Login(),
            /*const PruebasPage(),*/ /*VisualizerPage(),*/
            ...
            onGenerateRoute: (RouteSettings settings) {
              ...
              switch (settings.name) {
                case '/tourGuardado':
                  ...
                  builder = (BuildContext context) => SpecificTour(
                      tour: argumentos['tour'] as Tour,
                      indexTour: argumentos['indexTour'] as int);
                  break;
                ...
                case '/toursDisponibles/agregarEscena':
                  ...
                  builder = (BuildContext context) => AddImagePage(
                      sceneName: aux['sceneName'] as String,
                      imageList: aux['imageList'] as List<XFile>);
                  break;
                default:
                  Map<String, dynamic> aux =
                      settings.arguments as Map<String, dynamic>;
